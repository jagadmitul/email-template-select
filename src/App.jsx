...
import NewOrder from './templates/NewOrder.jsx';

const templates = {
  // 'order_confirmation_1': NewOrder,
  'order_confirmation_1': OrderConfirmation1,
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md">
        <div className="mb-4">
          ...
          >
            ...
            {/* <option value="order_confirmation_1">New Order</option> */}
